package com.jeonpeace.spring.ex.database.service;
...
import com.jeonpeace.spring.ex.database.repository.UsedGoodsRepository;
...
public class UsedGoodsService {
	...
	public List<UsedGoods> getUsedGoodsList() {
		...
		// usedGoods 테이블 모든 행 조회 => repository 역할
